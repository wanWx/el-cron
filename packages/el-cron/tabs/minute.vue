  ...
  <div class="config-list">
    <el-radio-group v-model="type">
      ...
      <div class="item">
        ...
        class="w85" v-model="valueRange.start" controls-position="right" size="mini"></el-input-number>分
        至<el-input-number :disabled="type!=TYPE_RANGE || disabled" :max="maxValue" :min="minValue" :precision="0"
        class="w85" v-model="valueRange.end" controls-position="right" size="mini"></el-input-number>分
      </div>
      <div class="item">
       ...
       class="w85" v-model="valueLoop.start" controls-position="right" size="mini"></el-input-number>分开始，间隔
        至<el-input-number :disabled="type!=TYPE_LOOP || disabled" :max="maxValue" :min="minValue" :precision="0"
       class="w85" v-model="valueLoop.interval" controls-position="right" size="mini"></el-input-number>分
      </div>
      <div class="item">
