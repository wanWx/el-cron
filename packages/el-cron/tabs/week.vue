<template>
  <div class="config-list">
    <el-radio-group v-model="type">
      ...
      <div class="item">
        <el-radio label="TYPE_RANGE" class="choice" :disabled="disableChoice">区间</el-radio>从
        <el-select v-model="valueRange.start" class="w85" :disabled="type!=TYPE_RANGE || disableChoice">
          <el-option
        ...
        <el-select v-model="valueRange.end" class="w85" :disabled="type!=TYPE_RANGE || disableChoice">
          <el-option
            v-for="(v, k) of WEEK_MAP"
      ...
      <div class="item">
        <el-radio label="TYPE_LOOP" class="choice" :disabled="disableChoice">循环</el-radio>从
        <el-select v-model="valueLoop.start" class="w85" :disabled="type!=TYPE_LOOP || disableChoice">
          <el-option
            v-for="(v, k) of WEEK_MAP"
            :key="`week-pre-Lf13-${v}`"
            :label="k"
        ...
        class="w85" v-model="valueLoop.interval" controls-position="right" size="mini"></el-input-number>天
      </div>
      <div class="item">
        ...
        <div class="list">
          <el-checkbox-group v-model="valueList">
            <el-checkbox 
              ...
              <span style="margin-right: 5px;">{{k}}</span>
            </el-checkbox>
          </el-checkbox-group>
        </div>
      </div>
